...
switch ($request) {
    ...
    case "/veterinaria/mi-agenda":
        require BASE_PATH .
            "/app/views/dashboard/veterinaria/agenda-veterinario.php";
        break;

    case "/veterinario/notificaciones":
    case "/veterinaria/notificaciones":
        require BASE_PATH .
            "/app/views/dashboard/veterinaria/notificaciones.php";
        break;
    ...
    case "/veterinario/agregar-disponibilidad-agenda":
        require BASE_PATH .
            "/app/controllers/disponibilidadUsuarioController.php";
        break;
    ...
    case "/representante/suscripcion":
        require BASE_PATH .
            "/app/views/dashboard/representante/suscripcion.php";
        break;

    case "/representante/reportes-servicios":
        require BASE_PATH .
            "/app/views/dashboard/representante/reportesServicios.php";
        break;

    case "/representante/reportes-servicios/data":
        require BASE_PATH .
            "/app/controllers/reportesServiciosRepresentanteController.php";
        break;
    ...
    case "/representante/reportes-citas":
        require BASE_PATH .
            "/app/views/dashboard/representante/reportesCitas.php";
        break;
    ...
    case "/veterinaria/gestion-pacientes":
        require BASE_PATH .
            "/app/views/dashboard/veterinaria/gestion-pacientes.php";
        break;
    ...
    case "/veterinario/registrar-pacientes":
        require BASE_PATH .
            "/app/views/dashboard/veterinaria/registro-pacientes.php";
        break;
    ...
    case "/veterinario/pacientes-asignacion":
        require BASE_PATH .
            "/app/controllers/pacienteProfesionalAsignacionController.php";
        break;

    case "/veterinaria/pacientes/acciones":
        require BASE_PATH .
            "/app/controllers/pacientesVeterinarioController.php";
        break;

    case "/veterinaria/gestion-pacientes/pdf":
        require BASE_PATH .
            "/app/controllers/historialesClinicosController.php";
        break;
    ...
    case "/veterinario/editar-veterinario":
        require BASE_PATH .
            "/app/views/dashboard/veterinaria/editar-veterinario.php";
        break;
    ...
    case "/admin/registro-usuario":
        require BASE_PATH .
            "/app/views/dashboard/administrador/registroUsuario.php";
        break;

    case "/admin/listar-usuarios":
        require BASE_PATH .
            "/app/views/dashboard/administrador/listaUsuarios.php";
        break;

    case "/admin/editar-usuario": // este es para pinatar los dato en el formulario
        require BASE_PATH .
            "/app/views/dashboard/administrador/editarUsuario.php";
        break;
    ...
    case "/admin/perfil-administrador":
        require BASE_PATH .
            "/app/views/dashboard/administrador/perfilAdministrador.php";
        break;
    ...
    case "/admin/registro-veterinaria":
        require BASE_PATH .
            "/app/views/dashboard/administrador/registroVeterinaria.php";
        break;
    ...
    case "/admin/listar-veterinarias":
        require BASE_PATH .
            "/app/views/dashboard/administrador/listaVeterinarias.php";
        break;

    case "/admin/editar-veterinaria":
        require BASE_PATH .
            "/app/views/dashboard/administrador/editarVeterinaria.php";
        break;
    ...
    case "/admin/listar-tickets":
        require BASE_PATH .
            "/app/views/dashboard/administrador/listaTicket.php";
        break;

    case "/admin/gestion-tickets":
        require BASE_PATH .
            "/app/views/dashboard/administrador/gestionTicket.php";
        break;
    ...
    case "/admin/listar-propietarios":
        require BASE_PATH .
            "/app/views/dashboard/administrador/listaPropietarios.php";
        break;
    ...
    case "/admin/reportes":
        require BASE_PATH .
            "/app/views/dashboard/administrador/reportesAdmin.php";
        break;
    ...
    case "/representante/dashboard":
        require BASE_PATH .
            "/app/views/dashboard/representante/dashboardRepresentante.php";
        break;

    case "/representante/veterinaria_info":
        require BASE_PATH .
            "/app/views/dashboard/representante/configVeterinaria.php";
        break;

    case "/representante/listar-especialidades":
        require BASE_PATH .
            "/app/views/dashboard/representante/listaEspecialidad.php";
        break;
    ...
    case "/representante/registro-profesionales":
        require BASE_PATH .
            "/app/views/dashboard/representante/registroProfesional.php";
        break;
    ...
    case "/representante/listar-profesionales":
        require BASE_PATH .
            "/app/views/dashboard/representante/listaProfesionales.php";
        break;

    case "/representante/editar-profesional":
        require BASE_PATH .
            "/app/views/dashboard/representante/editarProfesional.php";
        break;
    ...
    case "/representante/lista-agenda-usuario":
        require BASE_PATH .
            "/app/views/dashboard/representante/listaAgendaDisponibilidadUsuario.php";
        break;

    case "/representante/agenda-usuario":
        require BASE_PATH .
            "/app/views/dashboard/representante/agendaProfesional.php";
        break;
    ...
    case "/representante/perfil-representante":
        require BASE_PATH .
            "/app/views/dashboard/representante/perfilRepresentante.php";
        break;
    ...
    case "/representante/propietarios":
        require BASE_PATH .
            "/app/views/dashboard/representante/listaPropietarios.php";
        break;
    ...
    case "/representante/gestion_clinica":
        require BASE_PATH .
            "/app/views/dashboard/representante/gestion-clinica.php";
        break;
    ...
    case "/representante/registro-servicio":
        require BASE_PATH .
            "/app/views/dashboard/representante/registroServicio.php";
        break;

    case "/representante/editar-servicio":
        require BASE_PATH .
            "/app/views/dashboard/representante/editarServicio.php";
        break;

    case "/representante/listar-servicios":
        require BASE_PATH .
            "/app/views/dashboard/representante/listaServicios.php";
        break;
    ...
    case "/representante/registro-subservicio":
        require BASE_PATH .
            "/app/views/dashboard/representante/registrarSubservicio.php";
        break;
    ...
    case "/representante/listar-subservicios":
        require BASE_PATH .
            "/app/views/dashboard/representante/listaSubservicio.php";
        break;

    case "/representante/editar-subservicio":
        require BASE_PATH .
            "/app/views/dashboard/representante/editarSubservicio.php";
        break;
