...
function exportarACSV() {
    try {
        const data = tablaVeterinarias.rows({ search: 'applied' }).data();
...
function dataTableListVeterinarias() {
    try {
        tablaVeterinarias = $('#tablaListaVeterinarias').DataTable({
