    ...
    <div class="contenido-principal" id="contenidoPrincipal">
        ...
        <div class="wizard-container">
            <div class="wizard-header">
                ...
                <p class="text-muted">Complete todos los campos requeridos para editar el servicio</p>
            </div>


            <form id="registroProfesional" action="<?= BASE_URL ?>/representante/actualizar-servicio" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id_veterinaria" value="<?= $_SESSION['user']['id_veterinaria'] ?>">
                <input type="hidden" name="id_servicio" value="<?= $_GET['id'] ?>">
                <input type="hidden" id="horariosInput" name="horarios" value="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="estado" id="estado" required>
                                    ...
                                    <option <?= $servicio['estado'] === 'Activo' ? 'selected' : '' ?> value="Activo">Activo</option>
                                    <option <?= $servicio['estado'] === 'Inactivo' ? 'selected' : '' ?> value="Inactivo">Inactivo</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea maxlength="200" rows="4" cols="50" name="descripcion" id="descripcion" placeholder="Descripción del servicio"><?= $servicio['descripcion'] ?></textarea>
                            </div>
                        </div>
        ...
        <script src="<?= BASE_URL ?>/public/assets/dashBoard/representante/js/editarServicio.js"></script>
