...
<body data-pacientes-endpoint="<?= BASE_URL ?>/veterinaria/pacientes/acciones">
    ...
    <script src="<?= BASE_URL ?>/public/assets/dashBoard/veterinarias/js/dashBoardPacientesActions.js"></script>
